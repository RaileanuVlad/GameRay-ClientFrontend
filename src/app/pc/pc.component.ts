...
import { PcDetailModalComponent } from './pc-detail-modal/pc-detail-modal.component';
...
export class PcComponent implements OnInit {
  ...
  @ViewChild('pcDetailModal') pcDetailModal: PcDetailModalComponent;
  ...
  ngOnInit() {
    ...
    this.getDevelopers();
    this.getCategories();
    this.api.getGamesPlatform('pc').subscribe((data: Game[]) => {
